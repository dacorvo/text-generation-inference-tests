...
def get_metrics_from_cloudwatch(
    ...
    inference_time = {
        ...
        "Latency Inference ms med": df["inference_time_ms"].median(),
        "Latency Inference ms max": df["inference_time_ms"].max(),
        "Latency Inference ms p(90)": df["inference_time_ms"].quantile(0.9),
        "Latency Inference ms p(95)": df["inference_time_ms"].quantile(0.95),
        "Latency Inference ms avg": df["inference_time_ms"].mean(),
        "Latency Inference ms min": df["inference_time_ms"].min(),
